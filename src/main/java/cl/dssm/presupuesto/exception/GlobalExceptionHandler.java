...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(MercadoPublicoRateLimitException.class)
    public ResponseEntity<Map<String, Object>> handleMercadoPublicoRateLimit(MercadoPublicoRateLimitException ex, HttpServletRequest request) {
        return build(HttpStatus.TOO_MANY_REQUESTS, ex.getMessage() != null ? ex.getMessage() : "Mercado Público está limitando temporalmente las consultas. Intente nuevamente en unos segundos.", request);
    }
