...
public class CeroPapelController {
    ...
    @PostMapping("/purchase-requests/show")
    public CeroPapelPurchaseRequestDto show(@RequestBody java.util.Map<String, Object> body) {
        Object id = body.get("id");
        return service.getPurchaseRequest(id == null ? "" : String.valueOf(id));
    }
}
