...
public interface AppRoleRepository extends JpaRepository<AppRole, Long> {
    ...
    @Query("""
        ...
        """)
    Page<AppRole> search(@Param("search") String search, @Param("includeDeleted") boolean includeDeleted, Pageable pageable);
    ...
    @Query("""
        ...
        order by e.name
        """)
    List<AppRole> exportRows(@Param("search") String search, @Param("includeDeleted") boolean includeDeleted);
}
